...
<body>
            ...
            <div class="boxLetter">
                ...
                <div class="formLetter">
                    ...
                    <div class="wrapperLetter">
                        ...
                        <div class="mewmew2">
                            <img src="./image/mewmew.gif" alt="">  
                            <button class="button1" onclick="window.location.href='https://duykhanh06.x10.mx/';">🎁</button>
                            <script>
                                function redirectToPage() {
                                    window.location.href = "C:\Users\tkhan\Desktop\PhaoHoa2023-master\index.html";
                                }
                            </script>
                        </div>
                    </div>
    ...
    <script>
        ...
        const textLetterH2 = "Happy Vietnamese Women's Day!";
        ...
        const textLetterP = "Hôm nay là ngày 20/10. Xin gửi lời chúc tới các bạn  nữ. Luôn vui vẻ, luôn hạnh phúc và luôn may mắn trong cuộc sống, ngày càng xinh đẹp. Xin gửi tất cả lời chúc tốt đẹp đến với các baṇ.💗";
        ...
        function textCharLetterContent() {
            if (indexTextContent < textLetterP.length) {
                ...
                indexTextContent++;
                setTimeout(indexTextContent, 0.16);
            }
            else {
